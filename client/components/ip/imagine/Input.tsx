...
const IpImagineInput = ({
  ...
  return (
    <form
      className="chat-input flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 md:px-[1.45rem] py-2.5 sm:py-3 md:py-3.5 flex-none sticky bottom-0 z-10 transition-all duration-300"
